...
class FocalLoss(nn.Module):
    def __init__(self, alpha=1, gamma=2, reduction='mean'):
        """
        alpha: weight for each class, scalar or tensor of shape [num_classes]
    ...
    def forward(self, inputs, targets):
        ...
        # targets: ground truth labels [batch_size] (integer class indices)
...
class Resnet18_focalloss(pl.LightningModule):
    def __init__(self, model, num_classes = 2, lr = 1e-4, class_counts=None, alpha=0.25, gamma=2):
        super().__init__()
