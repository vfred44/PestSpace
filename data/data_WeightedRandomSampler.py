...
def prepare_datasets(cfg):
    ...
    return train_dataset, val_dataset, test_dataset, class_counts, sampler


def get_data_loaders(cfg):
   
    train_dataset, val_dataset, test_dataset, class_counts, sampler = prepare_datasets(cfg)

    train_loader = DataLoader(train_dataset, batch_size=cfg.data.batch_size, sampler=sampler, num_workers=cfg.data.num_workers)
